...
default = {
    ...
    "data_epoch_lengths": ["045_year_epoch"],
    # list of projects
    "data_projects": ["cmip6"],
    # list of experiments
    ...
    "fig_ticks": {
        "x_axis": {
            "030_year_epoch": {
                "ave_hf_val_n30e": [round(ii / 10, 1) for ii in list(range(0, 9, 2))],
                "ave_hf_val_n34e": [round(ii / 10, 1) for ii in list(range(0, 9, 2))],
                "ave_hf_val_n40e": [round(ii / 10, 1) for ii in list(range(1, 10, 2))],
                ...
                "ave_sl_val_n30e": [round(ii / 10, 1) for ii in list(range(0, 13, 3))],
                "ave_sl_val_n34e": [round(ii / 10, 1) for ii in list(range(0, 13, 3))],
                "ave_sl_val_n40e": [round(ii / 10, 1) for ii in list(range(0, 13, 3))],
                ...
                "ave_tx_val_n30e": [round(ii / 10, 1) for ii in list(range(0, 13, 3))],
                "ave_tx_val_n34e": [round(ii / 10, 1) for ii in list(range(0, 13, 3))],
                "ave_tx_val_n40e": [round(ii / 10, 1) for ii in list(range(0, 13, 3))],
                ...
                "ske_hf_ano_n30e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "ske_hf_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "ske_hf_ano_n40e": [round(ii / 100, 2) for ii in list(range(0, 41, 10))],
                ...
                "ske_sl_ano_n30e": [round(ii / 100, 2) for ii in list(range(0, 41, 10))],
                "ske_sl_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 33, 8))],
                "ske_sl_ano_n40e": [round(ii / 100, 2) for ii in list(range(0, 33, 8))],
                ...
                "ske_tx_ano_n34e": [round(ii / 100, 2) for ii in list(range(2, 31, 7))],
                "ske_tx_ano_n40e": [round(ii / 100, 2) for ii in list(range(5, 34, 7))],
                "ske_ty_ano_n30e": [round(ii / 100, 2) for ii in list(range(0, 25, 6))],
                "ske_ty_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 61, 15))],
                "ske_ty_ano_n40e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "var_hf_ano_n30e": list(range(0, 53, 13)),
                "var_hf_ano_n34e": list(range(0, 49, 12)),
                "var_hf_ano_n40e": list(range(0, 41, 10)),
                ...
                "var_sl_ano_n30e": list(range(0, 9, 2)),
                "var_sl_ano_n34e": [round(ii / 10, 1) for ii in list(range(0, 61, 15))],
                "var_sl_ano_n40e": list(range(0, 9, 2)),
                ...
                "var_ty_ano_n34e": [round(ii / 10, 1) for ii in list(range(0, 101, 25))],
                "var_ty_ano_n40e": list(range(0, 9, 2)),
            },
            "045_year_epoch": {
                "ave_hf_val_n30e": [round(ii / 100, 2) for ii in list(range(0, 61, 15))],
                "ave_hf_val_n34e": [round(ii / 100, 2) for ii in list(range(0, 61, 15))],
                "ave_hf_val_n40e": [round(ii / 10, 1) for ii in list(range(0, 9, 2))],
                ...
                "ske_hf_ano_n30e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "ske_hf_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "ske_hf_ano_n40e": [round(ii / 100, 2) for ii in list(range(0, 29, 7))],
                "ske_pr_ano_n30e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "ske_pr_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "ske_pr_ano_n40e": [round(ii / 100, 2) for ii in list(range(4, 29, 6))],
                "ske_sl_ano_n30e": [round(ii / 100, 2) for ii in list(range(4, 29, 6))],
                "ske_sl_ano_n34e": [round(ii / 100, 2) for ii in list(range(4, 25, 5))],
                "ske_sl_ano_n40e": [round(ii / 100, 2) for ii in list(range(4, 29, 6))],
                ...
                "var_hf_ano_n30e": list(range(0, 41, 10)),
                "var_hf_ano_n34e": list(range(0, 45, 11)),
                "var_hf_ano_n40e": list(range(0, 37, 9)),
                "var_pr_ano_n30e": [round(ii / 100, 2) for ii in list(range(0, 101, 25))],
                "var_pr_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 101, 25))],
                "var_pr_ano_n40e": [round(ii / 100, 2) for ii in list(range(0, 101, 25))],
                "var_sl_ano_n30e": [round(ii / 10, 1) for ii in list(range(0, 61, 15))],
                "var_sl_ano_n34e": [round(ii / 10, 1) for ii in list(range(0, 61, 15))],
                "var_sl_ano_n40e": list(range(0, 9, 2)),
            ...
            "060_year_epoch": {
                ...
                "ave_pr_val_n34e": [round(ii / 100, 2) for ii in list(range(0, 13, 3))],
                "ave_pr_val_n40e": [round(ii / 100, 2) for ii in list(range(0, 13, 3))],
                "ave_sl_val_n30e": [round(ii / 100, 2) for ii in list(range(0, 101, 25))],
                "ave_sl_val_n34e": [round(ii / 100, 2) for ii in list(range(0, 101, 25))],
                "ave_sl_val_n40e": [round(ii / 100, 2) for ii in list(range(0, 101, 25))],
                ...
                "ske_sl_ano_n30e": [round(ii / 100, 2) for ii in list(range(5, 18, 3))],
                "ske_sl_ano_n34e": [round(ii / 100, 2) for ii in list(range(5, 18, 3))],
                "ske_sl_ano_n40e": [round(ii / 100, 2) for ii in list(range(4, 37, 8))],
                ...
                "var_pr_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 101, 25))],
                "var_pr_ano_n40e": [round(ii / 100, 2) for ii in list(range(0, 101, 25))],
                "var_sl_ano_n30e": [round(ii / 10, 1) for ii in list(range(0, 61, 10))],
                "var_sl_ano_n34e": [round(ii / 10, 1) for ii in list(range(0, 37, 9))],
                "var_sl_ano_n40e": [round(ii / 10, 1) for ii in list(range(0, 33, 8))],
            ...
            "075_year_epoch": {
                ...
                "ske_sl_ano_n30e": [round(ii / 100, 2) for ii in list(range(5, 18, 3))],
                "ske_sl_ano_n34e": [round(ii / 100, 2) for ii in list(range(5, 18, 3))],
                "ske_sl_ano_n40e": [round(ii / 100, 2) for ii in list(range(4, 33, 7))],
                ...
                "var_sl_ano_n30e": [round(ii / 10, 1) for ii in list(range(0, 49, 12))],
                "var_sl_ano_n34e": [round(ii / 10, 1) for ii in list(range(0, 41, 10))],
                "var_sl_ano_n40e": [round(ii / 10, 1) for ii in list(range(0, 33, 8))],
            ...
            "090_year_epoch": {
                ...
                "ave_pr_val_n34e": [round(ii / 100, 2) for ii in list(range(0, 9, 2))],
                "ave_pr_val_n40e": [round(ii / 100, 2) for ii in list(range(1, 10, 2))],
                "ave_sl_val_n30e": [round(ii / 10, 1) for ii in list(range(0, 5, 1))],
                "ave_sl_val_n34e": [round(ii / 10, 1) for ii in list(range(0, 5, 1))],
                "ave_sl_val_n40e": [round(ii / 10, 1) for ii in list(range(0, 5, 1))],
                "ave_ts_val_n30e": [round(ii / 100, 2) for ii in list(range(0, 9, 2))],
                "ave_ts_val_n34e": [round(ii / 100, 2) for ii in list(range(0, 9, 2))],
                "ave_ts_val_n40e": [round(ii / 100, 2) for ii in list(range(0, 9, 2))],
                "ave_tx_val_n30e": [round(ii / 10, 1) for ii in list(range(0, 5, 1))],
                ...
                "ske_sl_ano_n30e": [round(ii / 100, 2) for ii in list(range(6, 19, 3))],
                "ske_sl_ano_n34e": [round(ii / 100, 2) for ii in list(range(4, 17, 3))],
                "ske_sl_ano_n40e": [round(ii / 100, 2) for ii in list(range(3, 24, 5))],
                ...
                "var_pr_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "var_pr_ano_n40e": [round(ii / 100, 2) for ii in list(range(0, 81, 20))],
                "var_sl_ano_n30e": [round(ii / 10, 1) for ii in list(range(0, 29, 7))],
                "var_sl_ano_n34e": [round(ii / 10, 1) for ii in list(range(0, 25, 6))],
                "var_sl_ano_n40e": [round(ii / 10, 1) for ii in list(range(0, 13, 3))],
                "var_ts_ano_n30e": [round(ii / 100, 2) for ii in list(range(0, 17, 4))],
                "var_ts_ano_n34e": [round(ii / 100, 2) for ii in list(range(0, 17, 4))],
                "var_ts_ano_n40e": [round(ii / 100, 2) for ii in list(range(0, 13, 3))],
