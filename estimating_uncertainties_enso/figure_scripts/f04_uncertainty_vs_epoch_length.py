...
default = {
    ...
    "fig_ticks": {
        ...
        "y_axis": {
            "maximum": {
                "ave_pr_val_n30e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
                "ave_pr_val_n34e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
                "ave_pr_val_n40e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
                "ave_ts_val_n30e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
                "ave_ts_val_n34e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
                "ave_ts_val_n40e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
                "ske_pr_ano_n30e": [round(k / 10, 1) for k in list(range(6, 39, 8))],
                "ske_pr_ano_n34e": [round(k / 10, 1) for k in list(range(6, 39, 8))],
                "ske_pr_ano_n40e": [round(k / 10, 1) for k in list(range(6, 39, 8))],
                "ske_ts_ano_n30e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
                "ske_ts_ano_n34e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
                "ske_ts_ano_n40e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
                "var_pr_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
                "var_pr_ano_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
                "var_pr_ano_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
                "var_ts_ano_n30e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
                "var_ts_ano_n34e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
                "var_ts_ano_n40e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
            },
        },
    },
    # "fig_ticks": {
    ...
    #     "y_axis": {
    #         "maximum": {
    #             "ave_hf_val_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_hf_val_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_hf_val_n40e": [round(k / 10, 1) for k in list(range(10, 55, 11))],
    #             "ave_pr_val_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_pr_val_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_pr_val_n40e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
    #             "ave_sl_val_n30e": [round(k / 10, 1) for k in list(range(10, 31, 5))],
    #             "ave_sl_val_n34e": [round(k / 10, 1) for k in list(range(10, 31, 5))],
    #             "ave_sl_val_n40e": [round(k / 10, 1) for k in list(range(10, 31, 5))],
    #             "ave_ts_val_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_ts_val_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_ts_val_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_tx_val_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_tx_val_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_tx_val_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_ty_val_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_ty_val_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ave_ty_val_n40e": [round(k / 10, 1) for k in list(range(10, 47, 9))],
    #             "cor_sl_n30e_to_ts_n30e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
    #             "cor_sl_n34e_to_ts_n34e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
    #             "cor_sl_n40e_to_ts_n40e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
    #             "cor_ts_n30e_to_hf_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "cor_ts_n34e_to_hf_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "cor_ts_n40e_to_hf_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "cor_ts_n30e_to_tx_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "cor_ts_n30e_to_tx_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "cor_ts_n34e_to_tx_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "fbk_sl_n30e_to_ts_n30e": [round(k / 10, 1) for k in list(range(8, 33, 6))],
    #             "fbk_sl_n34e_to_ts_n34e": [round(k / 10, 1) for k in list(range(8, 33, 6))],
    #             "fbk_sl_n40e_to_ts_n40e": [round(k / 10, 1) for k in list(range(8, 33, 6))],
    #             "fbk_ts_n30e_to_hf_n30e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
    #             "fbk_ts_n34e_to_hf_n34e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
    #             "fbk_ts_n40e_to_hf_n40e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
    #             "fbk_ts_n30e_to_tx_n34e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
    #             "fbk_ts_n30e_to_tx_n40e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
    #             "fbk_ts_n34e_to_tx_n40e": [round(k / 10, 1) for k in list(range(10, 43, 8))],
    #             "ske_hf_ano_n30e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
    #             "ske_hf_ano_n34e": [round(k / 10, 1) for k in list(range(10, 51, 10))],
    #             "ske_hf_ano_n40e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
    #             "ske_pr_ano_n30e": [round(k / 10, 1) for k in list(range(6, 35, 7))],
    #             "ske_pr_ano_n34e": [round(k / 10, 1) for k in list(range(8, 41, 8))],
    #             "ske_pr_ano_n40e": [round(k / 10, 1) for k in list(range(6, 35, 7))],
    #             "ske_sl_ano_n30e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
    #             "ske_sl_ano_n34e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
    #             "ske_sl_ano_n40e": [round(k / 10, 1) for k in list(range(10, 35, 6))],
    #             "ske_ts_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ske_ts_ano_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ske_ts_ano_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ske_tx_ano_n30e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
    #             "ske_tx_ano_n34e": [round(k / 10, 1) for k in list(range(10, 59, 12))],
    #             "ske_tx_ano_n40e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
    #             "ske_ty_ano_n30e": [round(k / 10, 1) for k in list(range(8, 33, 6))],
    #             "ske_ty_ano_n34e": [round(k / 10, 1) for k in list(range(8, 33, 6))],
    #             "ske_ty_ano_n40e": [round(k / 10, 1) for k in list(range(8, 33, 6))],
    #             "var_hf_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_hf_ano_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_hf_ano_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_pr_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_pr_ano_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_pr_ano_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_sl_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_sl_ano_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_sl_ano_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_ts_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_ts_ano_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_ts_ano_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_tx_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_tx_ano_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_tx_ano_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_ty_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_ty_ano_n34e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "var_ty_ano_n40e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #         },
    #     },
    # },
    # titles
