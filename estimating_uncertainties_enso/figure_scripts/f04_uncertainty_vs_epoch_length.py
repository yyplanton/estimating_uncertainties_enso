...
default = {
    ...
    #             "ske_ty_ano_n30e": [round(k / 10, 1) for k in list(range(10, 39, 7))],
    #             "ske_ty_ano_n34e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
    #             "ske_ty_ano_n40e": [round(k / 10, 1) for k in list(range(8, 37, 7))],
