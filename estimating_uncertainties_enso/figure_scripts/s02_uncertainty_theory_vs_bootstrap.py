...
default = {
    ...
    "fig_ticks": {
        "absolute": {
            ...
            "ave_pr_val_n34e": [round(k / 100, 2) for k in list(range(0, 29, 7))],
            "ave_pr_val_n40e": [round(k / 100, 2) for k in list(range(0, 41, 10))],
            "ave_ts_val_n30e": [round(k / 100, 2) for k in list(range(0, 21, 5))],
            "ave_ts_val_n34e": [round(k / 100, 2) for k in list(range(0, 21, 5))],
            "ave_ts_val_n40e": [round(k / 100, 2) for k in list(range(0, 21, 5))],
            # "ave_tx_val_n30e": [round(k / 10, 2) for k in list(range(0, 17, 4))],
            # "ave_tx_val_n34e": [round(k / 10, 2) for k in list(range(0, 21, 5))],
            # "ave_tx_val_n40e": [round(k / 10, 2) for k in list(range(0, 21, 5))],
            # "ave_ty_val_n30e": [round(k / 10, 2) for k in list(range(0, 21, 5))],
            # "ave_ty_val_n34e": [round(k / 10, 2) for k in list(range(0, 17, 4))],
            # "ave_ty_val_n40e": [round(k / 10, 2) for k in list(range(0, 9, 2))],
            "ske_pr_ano_n30e": [round(k / 100, 2) for k in list(range(0, 121, 30))],
            "ske_pr_ano_n34e": [round(k / 100, 2) for k in list(range(0, 141, 35))],
            "ske_pr_ano_n40e": [round(k / 100, 2) for k in list(range(0, 45, 11))],
            "ske_ts_ano_n30e": [round(k / 100, 2) for k in list(range(0, 41, 10))],
            "ske_ts_ano_n34e": [round(k / 100, 2) for k in list(range(0, 41, 10))],
            "ske_ts_ano_n40e": [round(k / 100, 2) for k in list(range(0, 33, 8))],
            # "ske_tx_ano_n30e": [round(k / 100, 2) for k in list(range(0, 29, 7))],
            # "ske_tx_ano_n34e": [round(k / 100, 2) for k in list(range(0, 29, 7))],
            # "ske_tx_ano_n40e": [round(k / 100, 2) for k in list(range(0, 29, 7))],
            # "ske_ty_ano_n30e": [round(k / 100, 2) for k in list(range(0, 33, 8))],
            # "ske_ty_ano_n34e": [round(k / 100, 2) for k in list(range(0, 61, 15))],
            # "ske_ty_ano_n40e": [round(k / 100, 2) for k in list(range(0, 81, 20))],
            "var_pr_ano_n30e": [round(k / 100, 2) for k in list(range(0, 121, 30))],
            "var_pr_ano_n34e": [round(k / 100, 2) for k in list(range(0, 161, 40))],
            "var_pr_ano_n40e": [round(k / 100, 2) for k in list(range(0, 201, 50))],
            "var_ts_ano_n30e": [round(k / 100, 2) for k in list(range(0, 41, 10))],
            "var_ts_ano_n34e": [round(k / 100, 2) for k in list(range(0, 45, 11))],
            "var_ts_ano_n40e": [round(k / 100, 2) for k in list(range(0, 33, 8))],
            # "var_tx_ano_n30e": list(range(0, 17, 4)),
            # "var_tx_ano_n34e": list(range(0, 41, 10)),
            # "var_tx_ano_n40e": list(range(0, 41, 10)),
            # "var_ty_ano_n30e": [round(k / 10, 1) for k in list(range(0, 61, 15))],
            # "var_ty_ano_n34e": list(range(0, 17, 4)),
            # "var_ty_ano_n40e": list(range(0, 13, 3)),
        },
    },
    # titles
