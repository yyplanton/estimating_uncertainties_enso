...
This remains true for other variables: [Net Surface Heat flux](f4_hf.md), [NHF regressed on SST](f4_hf_fbk.md), [PR](f4_pr.md), [Sea Surface Height](f4_sl.md), [SST regressed on SSH](f4_sl_fbk.md), [SST](f4_ts.md), [Taux regressed on SST](f4_tx_fbk.md), [Tauy](f4_ty.md)  
...
<iframe src="f04_uncertainty_vs_epoch_length_tx.pdf" width="100%" height="500" frameborder="0" />
