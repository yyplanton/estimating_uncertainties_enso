...
This remains true for other epoch lengths: [30](f5_ty_030.md), [60](f5_ty_060.md), [75](f5_ty_075.md), [90](f5_ty_090.md)-year epochs  
and other variables:  
...
<iframe src="f05_uncertainty_hi_vs_pi_ty_045_year_epoch.pdf" width="100%" height="500" frameborder="0" />
