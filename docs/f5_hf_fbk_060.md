...
This remains true for other epoch lengths: [30](f5_hf_fbk_030.md), [45](f5_hf_fbk_045.md), [75](f5_hf_fbk_075.md), [90](f5_hf_fbk_090.md)-year epochs  
and other variables:  
...
<iframe src="f05_uncertainty_hi_vs_pi_hf_fbk_060_year_epoch.pdf" width="100%" height="500" frameborder="0" />
